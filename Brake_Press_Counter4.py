...
shift_times = [['8:00','15:00'],['17:00','21:00']]  # first shift start and end time and then second shift start and end time Currntly second shift auto start is disabled
...
win.bind('<KP_Multiply-KP_Divide>',update_window)
